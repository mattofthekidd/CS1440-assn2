...
//            if (!m_analysts[analystIndex]->load(inputStream)) {
...
{
    m_symbolsCount = 0;
    // TODO: Go through all analysts' histories and build a list of symbols used in any Purchase-Sale-Sale.
    ...
    // if a symbol is already in that array.  If it is not, then the result is the std::end of the
